...
A label is written as its name. A name is a string of letters, digits
and underscores, and may not start with a digit; names must be unique
...
Beetle~\cite{beetledis} and an earlier version of Mite~\cite{mite0}, of
