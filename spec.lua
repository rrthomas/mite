...
inst = {
  ...
  Inst{"ldo",     {"s", "r", "R", "r"},  "$%2<-M_{%1}(%3+%4)$"},
  Inst{"sto",     {"s", "r", "R", "r"},  "$M_{%1}(%3+%4)<-%2$"},
  ...
  Inst{"lit",     {"i", "i", "i+"},      "$%2$ $%1$-byte literals $%3$"},
  ...
  Inst{"getret",  {"a", "r"},            "$%2<-\\syn{T}$ of type $%1$"},
  Inst{"retf",    {"a", "r"},            "pop \\syn{P}, $g_i$ ($i$ even); $\\syn{T}<-%2$ of type $%1$"},
